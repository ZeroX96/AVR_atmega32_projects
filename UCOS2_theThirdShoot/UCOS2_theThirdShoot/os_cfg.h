...
#define OS_CRITICAL_METHOD        3    /* Choose method (1 or 3) for enabling/disabling interrupts     */		//test_later_to_meet_the_atmega32_constrains
									   /* See os_cpu.h for more details								   */
...
#define OS_TICKS_PER_SEC        1000   /* Set the number of ticks in one second                        */							
                                       ...
                                       /* --------------------- TASK STACK SIZE ---------------------- */
#define OS_TASK_TMR_STK_SIZE    20u   /* Timer      task stack size (# of OS_STK wide entries)        */
#define OS_TASK_STAT_STK_SIZE   20u   /* Statistics task stack size (# of OS_STK wide entries)        */
#define OS_TASK_IDLE_STK_SIZE   20u   /* Idle       task stack size (# of OS_STK wide entries)        */
...
#define OS_TMR_CFG_WHEEL_SIZE     3u   /*     Size of timer wheel (#Spokes)                            */
