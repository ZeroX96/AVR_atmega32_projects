...
OS_STK  *OSTaskStkInit (void (*task)(void *pd), void *p_arg, OS_STK *ptos, INT16U opt)
{
    ...
    *ptos--  = (INT8U)0x31;            		/* R31   = 0x31                                             */
    //*ptos--  = (INT8U)0x00;            		/* EIND  = 0x00                                             */	//modified_by_msa_to_meet_the_atmega32_constrains
    //*ptos--  = (INT8U)0x00;            		/* RAMPD = 0x00                                             */  //modified_by_msa_to_meet_the_atmega32_constrains
	//*ptos--  = (INT8U)0x00;            		/* RAMPX = 0x00                                             */	//modified_by_msa_to_meet_the_atmega32_constrains
    //*ptos--  = (INT8U)0x00;            		/* RAMPY = 0x00                                             */	//modified_by_msa_to_meet_the_atmega32_constrains
    //*ptos--  = (INT8U)0x00;            		/* RAMPZ = 0x00                                             */	//modified_by_msa_to_meet_the_atmega32_constrains
